    ...
    Public Sub sqlCall()
        ...
        Try
            ...
            If txtFilter.Text = "" Then
                query = "SELECT FROM_UNIXTIME(timestamp, '%d/%m/%y %T') AS timestamp, a.rtmp_name AS racer_1_rtmp_name, b.rtmp_name AS racer_2_rtmp_name, CASE WHEN league = 0 THEN ""Playoffs"" WHEN league = 1 THEN ""Blood"" WHEN league = 2 THEN ""Titanium"" WHEN league = 3 THEN ""Obsidian"" WHEN league = 4 THEN ""Crystal"" END AS league FROM condor_s5.match_data JOIN condor_s5.user_data a ON a.racer_id=racer_1_id JOIN condor_s5.user_data b ON b.racer_id=racer_2_id WHERE week_number = @weekNumber AND flags & 8 !=0 AND flags & 16 != 0;"
            Else
